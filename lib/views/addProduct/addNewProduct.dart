...
class AddNewProduct extends StatelessWidget {
  String id;
  AddNewProduct({Key? key, required this.id}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    // var dbclass = context.read<DataBase>();
    var dbclass = Get.find<DataBase>();

    String id = dbclass.sellerId;
                              ...
                              child: Container(
                                ...
                                child: GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    child:
                                        GetBuilder<DataBase>(builder: (value) {
                                      return Row(
                                  ...
                                  Flexible(
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        border: const OutlineInputBorder(),
                                        prefixIcon:
                                            const Icon(FeatherIcons.maximize),
                                        prefixIconColor:
                                            Theme.of(context).primaryColor,
                                      ),
                                      validator: (value) {
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                decoration: InputDecoration(
                                  labelText: 'Title',
                                  border: const OutlineInputBorder(),
                                  prefixIcon: const Icon(FeatherIcons.linkedin),
                                  prefixIconColor:
                                      Theme.of(context).primaryColor,
                                ),
                                validator: (value) {
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  border: const OutlineInputBorder(),
                                  prefixIcon:
                                      const Icon(FeatherIcons.alignLeft),
                                  prefixIconColor:
                                      Theme.of(context).primaryColor,
                                ),
                                validator: (value) {
