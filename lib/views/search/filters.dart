                  ...
                  children: [
                    ...
                    TextFormField(
                      decoration: InputDecoration(
                        ...
                        prefixIcon: const Icon(FeatherIcons.file),
                      ...
                      child: Container(
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: GetBuilder<DataBase>(builder: (value) {
                              return Row(
                        ...
                        Flexible(
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: 'Min Price',
                              border: const OutlineInputBorder(),
                              prefixIcon: const Icon(FeatherIcons.watch),
                              prefixIconColor: Theme.of(context).primaryColor,
                            ),
                            validator: (value) {
                              if (value!.isEmpty) {
                        ...
                        Flexible(
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: 'Min Area',
                              border: const OutlineInputBorder(),
                              prefixIcon: const Icon(FeatherIcons.airplay),
                              prefixIconColor: Theme.of(context).primaryColor,
                            ),
                            validator: (value) {
                              if (value!.isEmpty) {
